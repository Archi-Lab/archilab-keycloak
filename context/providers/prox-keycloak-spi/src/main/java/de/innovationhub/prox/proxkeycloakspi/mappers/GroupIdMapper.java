package de.innovationhub.prox.proxkeycloakspi.mappers;
...
public class GroupIdMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper {
    ...
    private static final Logger log = Logger.getLogger(GroupIdMapper.class);
     ...
     */
    public static final String PROVIDER_ID = "oidc-group-id-mapper";
    ...
    static {
        ...
        OIDCAttributeMapperHelper.addIncludeInTokensConfig(configProperties, GroupIdMapper.class);
    ...
    public String getHelpText() {
        return "Maps the Group IDs to the claim";
    }

    @Override
    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession, KeycloakSession keycloakSession,
                            ClientSessionContext clientSessionCtx) {
        var group_ids = userSession.getUser().getGroups().stream().map(group -> group.getId()).collect(Collectors.toSet());
        String protocolClaim = mappingModel.getConfig().get(OIDCAttributeMapperHelper.TOKEN_CLAIM_NAME);
        token.getOtherClaims().put(protocolClaim, group_ids);
    }
